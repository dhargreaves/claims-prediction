...
class Evaluation():
    ...
    def evaluate_model(self,y_train,y_test,train_pred, test_pred, train_pred_proba, test_pred_proba):
        self.evaluation_metrics['train_kappa_score'] = self._get_cohen_kappa_score(y_train ,train_pred)
        self.evaluation_metrics['test_kappa_score'] = self._get_cohen_kappa_score(y_test ,test_pred)
